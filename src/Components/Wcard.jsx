...
const Wcard = ({ Text, title, className }) => {
  return (
    <div className='w-[340px] md:w-[630px] cursor-pointer group'>

      {/* IMAGE AREA */}
      <div className={`w-full h-[320px] md:h-[420px] bg-[#C4C4C4] relative overflow-hidden ${className}`}>
      ...
      <div className='w-full h-[100px] bg-c1'>
        <h2 className='font-vol font-semibold text-lg md:text-2xl text-white pt-[22px] pl-[18px]'>
          {title}
        </h2>
