...
const Subtitle = ({ className, Text , position}) => {
  ...
  <h4
    ...
    >
      {/* Icon wrapper */}
      <span className="absolute left-0 top-1/2 -translate-y-1/2 flex items-center transform -translate-x-12 opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
